...
const App = () => {
  ...
  return (
    <div className="flex h-screen">
      {/* Sidebar */}
      <nav className="w-1/5 bg-[#1A3836] text-white fixed h-screen top-0 left-0">
      ...
      {/* Contenu Dynamique */}
      <div id="contentDynamic" className="w-4/5 p-6 bg-gray-100 top-0 right-0 absolute">{selectedComponent}</div>
    </div>
  );
};
